  ...
  public: {
    ...
    Views: {
      ...
      variant_sightings_public: {
        Row: {
          availability: Database["public"]["Enums"]["sighting_availability"] | null;
          confirmation_count: number | null;
          currency: string | null;
          location_area: string | null;
          location_granularity: Database["public"]["Enums"]["location_granularity"] | null;
          location_id: string | null;
    ...
    Enums: {
      ...
      dispute_status: "open" | "under_review" | "resolved_buyer" | "resolved_seller" | "withdrawn";
      item_condition: "new_with_tags" | "new_without_tags" | "used_excellent" | "used_good";
      listing_event_type:
        | "created"
        | "price_changed"
        | "cancelled"
      ...
      order_evidence_kind:
        "purchase_receipt" | "item_photo" | "delivery_proof" | "dispute_evidence";
      order_origin:
        | "buy_now"
        | "sell_now"
        | "sourcing_quote"
      ...
      payout_status: "pending" | "processing" | "completed" | "failed" | "reversed";
      price_evidence_source:
        "member_report" | "approved_shopper" | "receipt_verified" | "admin_verified";
      product_image_kind: "canonical" | "seller_evidence";
      product_status: "draft" | "pending_review" | "published" | "rejected" | "archived";
      release_type:
        | "open_edition"
        | "limited_edition"
        | "seasonal"
        ...
        | "limited_release";
      shipment_status:
        "pending" | "label_created" | "shipped" | "in_transit" | "delivered" | "exception";
      shopper_application_status: "submitted" | "in_review" | "approved" | "rejected";
      shopper_quote_status: "submitted" | "accepted" | "declined" | "expired" | "withdrawn";
      sighting_availability: "in_stock" | "limited" | "sold_out";
      sourcing_assignment_status:
        "assigned" | "purchase_confirmed" | "unavailable" | "completed" | "cancelled";
      sourcing_request_status: "open" | "quote_accepted" | "cancelled" | "expired";
      suggestion_status: "submitted" | "in_review" | "approved" | "rejected" | "merged_duplicate";
    };
    CompositeTypes: {
      [_ in never]: never;
    };
...
export const Constants = {
  public: {
    Enums: {
      ...
      match_status: ["active", "released", "completed", "cancelled"],
      member_intent: ["buying", "selling", "shopping_in_park", "browsing"],
      order_evidence_kind: ["purchase_receipt", "item_photo", "delivery_proof", "dispute_evidence"],
      order_origin: [
        "buy_now",
        "sell_now",
        "sourcing_quote",
