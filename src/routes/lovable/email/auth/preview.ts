/* eslint-disable @typescript-eslint/no-explicit-any -- preview registry contains heterogeneous email components */
...
const SAMPLE_PROJECT_URL = "https://gemstateclassifieds.lovable.app";
