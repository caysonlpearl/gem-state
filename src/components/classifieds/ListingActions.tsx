  ...
  return (
    <div className="floating-card overflow-hidden border-foreground/20">
      <div className="px-4 pt-4">
        <p className="numeric text-[30px] font-bold leading-none">{formatUsd(listing.priceCents)}</p>
        <p className="mt-2 text-[12px] leading-relaxed text-muted-foreground">
          Contact the seller to ask questions and arrange pickup, shipping, and payment directly.
        </p>
      ...
      <p className="border-t border-border px-4 py-3 text-[11px] leading-relaxed text-muted-foreground">
        Gem State does not process payment for this listing. Confirm the item, price, and meeting
        or shipping details with the seller before exchanging money.
      </p>
    </div>
  );
}
