-- Gem State classifieds currently use direct seller contact. Stripe payout
-- onboarding is intentionally optional, so listing creation must not require
-- Stripe identity or payout verification.
